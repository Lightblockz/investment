...
<style id="media-query" type="text/css">
    ...
    @media (max-width: 920px) {
			img.center.autowidth.fullwidth.side-img {
			    margin-top: 50px;
			}
			.our-class p{
		...
		@media (max-width:768px) {
			img.center.autowidth.fullwidth.banner-img {
			    margin-top: 40px;
			}
      .go-to-dashboard {
        padding: 20px !important;
...
<div class=""><div class="aHl"></div><div id=":3d" tabindex="-1"></div><div id=":2n" class="ii gt"><div id=":2o" class="a3s aXjCH "><u></u>
																								...
																								<tbody>
																									<tr style="vertical-align:top">
																										<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;width:100%;padding-top:10px;padding-right:30px;padding-bottom:10px;padding-left:30px" align="center">
																											<div align="center">
																												<img style="outline:none;text-decoration:none;clear:both;display:block;border:0;height:auto;line-height:100%;margin:0 auto;float:none;max-height:40px" align="center" border="0" src="https://lightblocks.biz/images/lightblocksblue.png" alt="Image" title="Image" class="CToWUd">
																											</div>
																										</td>
																									</tr>
																								</tbody>
																				...
																				<tbody>
																					...
																					<tr style="vertical-align:top">
																						<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;background-color:transparent;padding-top:0;padding-right:0;padding-bottom:30px;padding-left:0;border-top:1px solid #ededed;border-right:1px solid #ededed;border-bottom:1px solid #ededed;border-left:1px solid #ededed">
																							...
																							<div style="font-size:14px;line-height:22px;text-align:center;color:white;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif;padding-top:15px;padding-right:10px;padding-bottom:15px;padding-left:10px;background:#0d3e65">
																								<h2 style="margin:0;font-size:22px;line-height:17px;text-align:center">New trade signal subscription awaiting confirmation</h2>
																							</div>
                                                                                            
                                                                                            <div style="margin:0;padding-top:10px;padding-bottom:10px;padding-left:15px;padding-right:15px;background-color:#f9f9f9;border-radius:6px;color:#555555;text-align:left;">
                                                                                                <p style="line-height:22px;font-size:14px;text-align:left;">
                                                                                                   
                                                                                                    Dear Admin, <br> <br> 

                                                                                                    A user just subscribe to our trade signals. Find details of this subscription below:
                                                                                                </p>
                                                                                                <br>
                                                                                                <p style="line-height:22px;font-size:14px;text-align:left;">
                                                                                                   
                                                                                                    Note: This transaction needs to be confirmed or rejected in the next 6 hours
                                                                                                </p>

                                                                                                <br><br>

                                                                                                <h4 style="margin:0;font-size:20px;line-height:17px;text-align:left">Subscription Details</h4>
                                                                                                <br>
                                                                                                <p style="line-height:22px;font-size:14px;text-align:left;">
                                                                                                ...
                                                                                                <br>
                                                                                                <p style="line-height:22px;font-size:14px;text-align:left;">
                                                                                                    <b>Amount:</b> {{ $details->amount_paid }}
                                                                                                </p>

                                                                                                <p style="line-height:22px;font-size:14px;text-align:left;">
                                                                                                Log in to approve this transaction:

                                                                                                    <a href="https://dashboard.lightblocks.biz/index.php/signin">
                                                                                                        Login
                                                                                                    </a>
                                                                                                </p>
                                                                                            </div>
																									...
																									<tr style="vertical-align:top">
																										<td style="word-break:break-word;border-collapse:collapse!important;vertical-align:top;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px">
																											<div style="color:#555555;line-height:120%;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif">
																												<div style="font-size:12px;line-height:14px;text-align:center;color:#555555;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif">
																													<p style="margin:0;font-size:12px;line-height:14px;text-align:center">© LightBlocks 2021
																													</p>
																												</div>
																											</div>
																										</td>
