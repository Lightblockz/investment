                    ...
                    <div style="font-size:16px;text-align:left;">
                        <div class="email-header" style="padding:60px; padding-left:100px">
                            ...
                            <p class="email-text-2" style="margin-bottom:40px;color: #707070;font-size:16px;text-align:left;line-height: 35px;">
                                You requested to reset your password. Not to worry, Kindly click the button below to reset your password. 
                            </p>

                            <div class="text-center">
                                <a href="{{ $url }}" class="btn-block go-to-dashboard" style="width:100%; color:#fff;margin: 0px 150px;">Reset password</a>
                            </div>
